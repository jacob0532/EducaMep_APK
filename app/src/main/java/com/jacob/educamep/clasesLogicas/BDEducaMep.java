                    ...
                    case 1: //Gestion de cursos
                        switch (accion2){
                            ...
                            case 2: //mostrar
                                ...
                                break;
                            case 3: //modificar
                                resultado = varAdministrador.modificarCurso(params[0].toString(),params[1].toString(),params[2].toString());
                                break;
                            case 4: //eliminar
                                resultado = varAdministrador.eliminarCurso(params[0].toString());
                                break;
                        }
                        break;
