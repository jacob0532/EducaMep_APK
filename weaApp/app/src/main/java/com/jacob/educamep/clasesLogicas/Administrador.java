...
public class Administrador extends Usuario implements Serializable {
    ...
    * *********************
    ...
    public String modificarDocente(long cedula, String nombre, String apellido1, String apellido2, String correo){
        String registrar_url = "http://educamep.freeoda.com/scriptsEducaMep/Administrador/actualizarDocuente.php";
        try {
            Log.d("MI APP","Inicia....");
            URL url = new URL(registrar_url);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
    ...
    public String eliminarDocente(long cedula){
        String registrar_url = "http://educamep.freeoda.com/scriptsEducaMep/Administrador/borrarDocente.php";
        try {
            Log.d("MI APP","Inicia....");
            URL url = new URL(registrar_url);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
    ...
    public returnAsync mostrarDocente(){
        ArrayList<String[]> list = new ArrayList<String[]>();
        String registrar_url = "http://educamep.freeoda.com/scriptsEducaMep/Administrador/mostrarDocentes.php";
        try {
            URL url = new URL(registrar_url);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("POST");
